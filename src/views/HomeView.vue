...
<template>
  <main>
    ...
    <div class="pb-3">
      ...
      Assess the mathematical reasoning and problem-solving abilities of language models at an advanced level (high
      school/early college)
    </div>
    <div class="pb-3">
      <Tag value="MUSR" style="margin-right: 0.5rem;" />
      Multi-step Soft Reasoning, the capability of the model to make a series of decisions or deductions, where each
      step depends on the outcome of the previous one
    </div>
    <div class="pb-3">
